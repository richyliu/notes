...
{
	if (region.bg.aG === region.bx.aG)
	{
		return 'on line ' + region.bg.aG;
	}
	return 'on lines ' + region.bg.aG + ' through ' + region.bx.aG;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.p, request.cA, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cf: 'hidden', b8: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cf: 'mozHidden', b8: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cf: 'msHidden', b8: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cf: 'webkitHidden', b8: 'webkitvisibilitychange' }
		: { cf: 'hidden', b8: 'visibilitychange' };
}
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{Z: false, b7: r.b7, cc: r.cc, l: r.l, p: r.p, q: r.q, u: r.u, cA: r.cA}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{b7: elm$http$Http$emptyBody, cc: r.cc, l: _List_Nil, p: 'GET', q: elm$core$Maybe$Nothing, u: elm$core$Maybe$Nothing, cA: r.cA});
};
	...
	return _Utils_Tuple2(
		{
			aE: 3,
			aj: '',
			aH: author$project$Main$Loading,
			t: _List_fromArray(
				[
					{A: 'eat food', s: false, v: 0},
					{A: 'foo bar', s: false, v: 1},
					{A: 'baz', s: false, v: 2}
				])
		},
		elm$http$Http$get(
			{
				cc: elm$http$Http$expectString(author$project$Main$GotText),
				cA: 'https://elm-lang.org/assets/public-opinion.txt'
			}));
};
...
var author$project$Main$getNextId = function (model) {
	return model.aE;
};
var author$project$Main$createTodo = F2(
	function (model, content) {
		return {
			A: content,
			s: false,
			v: author$project$Main$getNextId(model)
		};
	});
var author$project$Main$incrementIdCounter = function (model) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				var content = model.aj;
				if (elm$core$String$length(content) > 0) {
					var nextModel = author$project$Main$incrementIdCounter(model);
					return _Utils_Tuple2(
						_Utils_update(
							nextModel,
							{
								...
								t: A2(
									elm$core$List$cons,
									A2(author$project$Main$createTodo, nextModel, content),
									nextModel.t)
							}),
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aH: author$project$Main$Success(fullText)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{aH: author$project$Main$Failure}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
...
var author$project$Main$viewLoad = function (model) {
	var _n0 = model.aH;
	switch (_n0.$) {
		case 0:
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A3(elm$core$String$slice, 0, 100, fullText))
					]));
	}
};
...
var author$project$Main$checkBox = function (isChecked) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$input,
...
var author$project$Main$viewTodosList = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							author$project$Main$Toggle(todo.v))
						]),
					_List_fromArray(
						[
							A2(
							elm$html$Html$span,
							_List_Nil,
							author$project$Main$checkBox(todo.s)),
							A2(
							elm$html$Html$span,
							_List_Nil,
							_List_fromArray(
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									elm$core$String$fromInt(todo.v))
								]))
						]));
			},
			A2(
				...
				F2(
					function (a, b) {
						return _Utils_eq(a.s, b.s) ? A2(elm$core$Basics$compare, a.A, b.A) : (a.s ? 2 : 0);
					}),
				model.t)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						function (t) {
							return (t === 13) ? author$project$Main$Add : author$project$Main$NoOp;
						}),
						elm$html$Html$Attributes$value(model.aj),
						elm$html$Html$Attributes$placeholder('Type a todo...')
					]),
				_List_Nil),
				A2(
				...
				author$project$Main$viewTodosList(model),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						author$project$Main$viewLoad(model)
					]))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bA: fragment, bB: host, bK: path, bM: port_, bP: protocol, bQ: query};
	});
...
var author$project$Main$main = elm$browser$Browser$element(
	{ci: author$project$Main$init, cw: author$project$Main$subscriptions, cy: author$project$Main$update, cB: author$project$Main$view});
